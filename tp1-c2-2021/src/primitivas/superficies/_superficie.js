export default class Superficie {
  ...
  getIndexBuffer(rows = 128, columns = 128) {
    ...
    // RECORDAR QUE SI CAMBIAMOS ESTO, HAY QUE HACERLO TMB EN LA SUPERFICUE
    // DE BARRIDO, DE LO CONTRARIO, LAS SUPERFICIES NO CIERRAN, POR LA DIFERENCIA
    // DE INDEX, POSITION y NORMAL BUFFERS
